    ...
    <div className="p-8">
      ...
      <div className="lg:flex lg:justify-around">
        <div className="flex justify-center">
          <div className="mb-24 lg:mb-0 bg-gradient-to-r dark:from-blue-950 dark:to-cyan-900 from-purple-400 to-white w-[450px] xl:w-[600px] rounded-3xl p-6 shadow-[-30px_30px_10px_10px_#00000024]">
      ...
      <div className="flex justify-around mt-7 md:justify-center md:gap-24">
        <BackButton href="/MembersHome/Anxiety-Recovery/Introduction/RecoveryStory" />
        <NextButton href="/MembersHome/Anxiety-Recovery/Introduction/AnxietyDisorderCauses" />
      </div>
    </div>
  );
};
